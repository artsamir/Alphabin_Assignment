...
public class AmazonSteps {
	...
	public void i_get_all_available_categories_from_the_dropdown_menu_and_store_them_in_an_array() {
		...
		home.selectCategory(dropdownValues);
		
		for(String value : dropdownValues) {
			System.out.println("The Search Category Option list : " + value);
		}	
	...
	public void i_should_be_able_to_randomly_select_a_category_from_the_array_and_apply_the_filter() {
		...
		home.SelectOptionRandomly(dropdownValues, value);		
		// click search button
		home.clickSearchBtn();
	}
...
//		Assert.assertTrue(actualResult.contains(expectedResult), "The search results not matched chosen category");
		
		// print actualResult and expectedResult
//		System.out.println("The Actual Search result : " + actualResult);
		System.out.println("The expected Search result should be : " + expectedResult);
	}
/*
